...
MockDB.predictionSummary = {
  ...
  insights: [
    {
      tone: "primary",
      text: "Most learners are currently classified as Low Risk",
    },
    {
      tone: "error",
      text: "Three learners recently moved from Moderate to High Risk",
    },
  ],
};
