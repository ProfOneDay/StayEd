...
class ProfileSettingsPage {
    ...
    static populateFromUser() {
        ...
        document.querySelector("[data-change-photo]")?.addEventListener("click", () => {
            Toast?.info("Photo upload will be available once connected to the server.");
        });
    ...
    static bindTheme() {
        ...
        document.querySelectorAll("[data-theme-option]").forEach(option => {
            ...
            option.addEventListener("click", () => {
                ...
                document.querySelectorAll("[data-theme-option]").forEach(o => o.classList.remove("is-selected"));

                option.classList.add("is-selected");

                this.savePreference("theme", option.dataset.themeOption);

                Toast?.info(`Theme set to ${option.dataset.themeOption}. Full theming support is coming soon.`);
    ...
    static bindDangerZone() {
        ...
        document.querySelector("[data-deactivate-account]")?.addEventListener("click", () => {
            ...
            Modal.show({
                ...
                message: "Are you sure you want to deactivate your account? You will lose access to administrative tools until it is reactivated by a Division Administrator.",
    ...
    static restorePreferences() {
        ...
        Object.entries(prefs).forEach(([key, value]) => {
            ...
            const toggle = document.querySelector(`[data-settings-toggle-pref="${key}"]`);
...
(function bootProfileSettings() {
    let started = false;
    const start = () => { if (!started) { started = true; ProfileSettingsPage.init(); } };
