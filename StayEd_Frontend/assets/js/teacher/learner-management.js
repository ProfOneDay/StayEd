 ...
 * ============================================
 * StayEd
 * Learner Management Controller
 * ============================================
 *
 * Full learner management: search, filters,
 * sortable columns, pagination, row selection,
 * and bulk actions (export / archive / delete).
 *
 * Renamed from "Learner Roster" throughout the
 * app per the current information architecture.
 * ============================================
 */
...
class LearnerManagement {
    ...
    static async load() {
        ...
        try {
            ...
            console.error("[LearnerManagement]", error);
    ...
    static bulkDelete() {
        ...
        Modal.show({
            ...
            onConfirm: async () => {
                ...
                for (const id of ids) {
                    try { await API.deleteLearner(id); } catch { /* continue */ }
                }
